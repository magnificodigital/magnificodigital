...
if (class_exists('Redux')) {
	require_once $template_dir . '/plugins/redux-framework/extensions-config.php';
	require_once $template_dir . '/plugins/redux-framework/config.php';
} else {
	require_once $template_dir . '/plugins/redux-framework/default-options.php';
}


require_once $template_dir . '/inc/helpers/template-tags.php';

require_once $template_dir . '/inc/helpers/modules.php';

require_once $template_dir . '/inc/helpers/post-formats.php';


/*
 * Shop settings.
 */
require_once $template_dir . '/woocommerce/index.php';


/*
 * Visual Composer settings.
 */
require_once $template_dir . '/plugins/js_composer/index.php';
...
function melinda_scripts() {
	...
	wp_register_script( 'requestAnimationFrame', get_template_directory_uri() . '/scripts/vendor/requestAnimationFrame/requestAnimationFrame.js', array(), false, true );
	wp_register_script( 'jqueryui', get_template_directory_uri() . '/scripts/vendor/jquery.ui/jquery-ui.min.js', array('jquery'), false, true );
	wp_register_script( 'flexslider', get_template_directory_uri() . '/scripts/vendor/flexslider/jquery.flexslider-min.js', array('jquery'), false, true );
	wp_register_script( 'photoswipe', get_template_directory_uri() . '/scripts/vendor/photoswipe/dist/photoswipe.min.js', array('jquery'), false, true );
	wp_register_script( 'photoswipeui', get_template_directory_uri() . '/scripts/vendor/photoswipe/dist/photoswipe-ui-default.min.js', array('jquery', 'photoswipe'), false, true );
	wp_register_script( 'isotope', get_template_directory_uri() . '/scripts/vendor/isotope/dist/isotope.pkgd.min.js', array(), false, true );
	wp_register_script( 'smooth-scroll', get_template_directory_uri() . '/scripts/vendor/jquery-smooth-scroll/jquery.smooth-scroll.min.js', array('jquery'), false, true );
	wp_enqueue_script( 'melinda_main', get_template_directory_uri() . '/scripts/local/main.js', array( 'requestAnimationFrame', 'jqueryui', 'flexslider', 'photoswipe', 'photoswipeui', 'isotope', 'smooth-scroll' ), false, true );
