...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(
			...
			array(
				'id' => 'header--popup_menu',
				'type' => 'switch',
				'title' => esc_html__('Show menu like popup module?', 'melinda'),
				'subtitle' => esc_html__('Better for small menus.', 'melinda'),
				'default' => 0,
				'required' => array('header--mobile_menu', '=', 0),
			),
