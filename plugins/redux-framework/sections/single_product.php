...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		array(
			...
			'default' => '',
			'required' => array('single_product--layout--content_width', '!=', 'expanded'),
		),

		array(
			'id' => 'single_product--layout--content_width',
			'type' => 'select',
			...
			array(
				'id' => 'single_product_styles--bg_color',
				'type' => 'color',
				'title' => esc_html__('Expanded layout background color', 'melinda'),
				'subtitle' => esc_html__('Pick an background color that will be used under product images and summary.', 'melinda'),
				'transparent' => false,
				'validate' => 'color',
				'required' => array('single_product--layout--content_width', '=', 'expanded'),
			),
