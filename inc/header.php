		...
		<?php
			...
			if (
				...
				<?php if(is_page(5964)){ ?>
					...
					<nav class="main-menu-w <?php if ($mobile_menu) { echo 'hidden-xs hidden-sm hidden-md'; } ?>">
						<ul id="menu-menu-1" class="js--scroll-nav main-menu">
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-12291"><a href="#home-top">Home</a></li>
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-12293"><a href="#quemsomos">Quem somos</a></li>
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-12294"><a href="#oquefazemos">O que fazemos</a></li>
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-12292"><a href="#blog">Blog</a></li>
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-12295"><a href="#contato">Contato</a></li>
						</ul>
					</nav>
