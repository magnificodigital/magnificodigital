...
function get_icon_module_search($section = 'header', $large_icon = true) {
	if (get_theme_option($section . '--search')) {
		...
		<div class="mods_el"><div class="search-form-popup-w js--focus-w">
			<a href="#" class="js--show-next js--focus js--scroll-disable"><span class="mods_el-ic"><span class="icon-search <?php if ($large_icon) echo 'xbig'; ?>"></span></span></a>
			<?php get_search_form(); ?>
		</div></div>
		<?php
	}
...
function get_icon_module_popup_menu($large_icon = true, $hide_on_screen_lg = true) {
	...
	<div class="mods_el<?php if ($hide_on_screen_lg) { ?> hidden-lg<?php } ?>"><div class="popup-menu-mod">
		<a href="#" class="js--show-next js--scroll-disable"><span class="mods_el-ic"><span class="icon-menu <?php if ($large_icon) echo 'xbig'; ?>"></span></span></a>
