...
<head>
	<meta name="google-site-verification" content="c2Zgd5JRsYjXcd3IIbUw0r2vM1kuYxHKZUB1IJAOBxo" />
	...
	<script>
	  ...
	  ga('create', 'UA-81491633-1', 'auto');
	  ga('send', 'pageview');

	</script>

	<link rel="alternate" hreflang="pt-br" href="<?php bloginfo('url') ?>" />
</head>
